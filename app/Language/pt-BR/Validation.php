...
return [
    ...
    'is_not_unique'         => 'O campo {field} deve conter um valor previamente existente no banco de dados.',
    ...
    // Cartões de crédito
    'valid_cc_num' => 'O campo {field} não parece ser um número de cartão de crédito válido.',

    // Arquivos
    'uploaded' => 'O campo {field} não é um arquivo enviado válido.',
    'max_size' => 'O campo {field} é muito grande.',
    'is_image' => 'O campo {field} não é uma imagem enviada válida.',
    'mime_in'  => 'O campo {field} não possui um tipo MIME válido.',
    'ext_in'   => 'O campo {field} não possui uma extensão de arquivo válida.',
    'max_dims' => 'O campo {field} não é uma imagem ou é muito larga ou alta.',
];
