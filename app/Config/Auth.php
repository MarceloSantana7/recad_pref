...
class Auth extends ShieldAuth
{
    ...
    public array $views = [
        ...
        'action_email_activate_show'  => '\shield\register\email_activate_show',
    ...
    public array $models = [
        'user' => \App\Models\CustomUserModel::class, // Modelo customizado
    ];
     ...
     */
    public string $userProvider = \App\Models\CustomUserModel::class;
