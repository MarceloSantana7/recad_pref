...
<div class="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md mt-6">
    ...
    <div class="flex flex-col md:flex-row items-center mb-6">
        ...
        <div class="ml-0 md:ml-6 mt-4 md:mt-0 text-center md:text-left">
            ...
            <p class="text-lg font-medium text-gray-800">Data de Nascimento:
                <?= formatDate($servidor['data_nascimento']) ?></p>
        </div>
    </div>
    ...
    <div class="border-t border-gray-300 pt-4 mt-6 text-center">
        <p class="text-sm text-gray-600">Comprovante gerado em:
            <?= (new DateTime($servidor['updated_at']))->format('d/m/Y H:i:s') ?></p>
    ...
    <div class="flex space-x-4 mt-6 justify-center ">
        <!-- Botão para imprimir -->
        <button id="print-button" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">
            Imprimir
        </button>
        <!-- Botão para Retornar ao Dashboard -->
        <a href="<?= base_url('cadastrador/dashboard') ?>"
            id="backDashboard"
            class="bg-gray-500 text-white text-sm font-medium py-2 px-4 rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
            Voltar ao Dashboard
        </a>
    </div>
